...
if 'microsoft' not in platform.uname().release.lower():
    ...
    output_dir = opj('/mnt', 'd', 'ChongLiu', 'OneDrive', 'Papers', 'dy')
...
def build3d(i, smi):
    ...
    mol.complexes_build_optimize_(save_screenshot=True)
    mol.write(opj(f'/mnt/d/Chong Liu/OneDrive/Papers/dy/gjf/pair/{i}.gjf'), overwrite=True, write_single=True)
    mol.write(opj(f'/mnt/d/Chong Liu/OneDrive/Papers/dy/sdf/pair/{i}.sdf'), overwrite=True, write_single=True)
    # linux
    ...
    # windows
    mol.write(opj(f'/mnt/d/Chong Liu/OneDrive/Papers/dy/gjf/ligand/{i}.gjf'), overwrite=True, write_single=True)
